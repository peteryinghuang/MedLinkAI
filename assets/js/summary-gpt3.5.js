...
var GPTHistory = {
  messages: [
    ...
    {
      "role": "assistant",
      "content": `Hello and welcome!\n I am Dr. GPT3.5 at MedLinkAI. May I know your pre-diagnosis information?`
    },
  ]
};
...
function initChat() {
  $('<div class="message loading new"><figure class="avatar"><img src="../assets/img/openai_logo_4.png" /></figure><span></span></div>').appendTo($('.mCSB_container'));
  updateScrollbar();
  setTimeout(function() {
    $('.message.loading').remove();
    $('<div class="message new"><figure class="avatar"><img src="../assets/img/openai_logo_4.png" /></figure>' + GPTHistory.messages[1].content + '</div>').appendTo($('.mCSB_container')).addClass('new');
    setDate();
    updateScrollbar();
    i++;
  }, 0.5);
...
async function startMessage() {
  if (GPTHistory.messages.length === 2 && userMessage === '') {
    ...
    try {
      ...
      $('.message.loading').remove();
      $('<div class="message new"><figure class="avatar"><img src="../assets/img/openai_logo_4.png" /></figure>' + generatedText + '</div>').appendTo($('.mCSB_container')).addClass('new');
      setDate();
      updateScrollbar();
      i++;
    } catch (error) {
